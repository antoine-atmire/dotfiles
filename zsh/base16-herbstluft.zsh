...
function base16_herbstluft() {
    ...
    color02="e8/8e/2c" # Green (changed to orange)
    color03="ae/81/ff" # Yellow
    color04="8e/4b/27" # Blue (changed to brown)
    # color04="7a/a5/ff" # Blue
    color05="ed/47/81" # Magenta
    color06="a0/75/48" # Cyan (changed to light brown?)
    # color06="67/8b/dc" # Cyan
    color07="6d/90/90" # White
    # color08=$color04 # Bright Black
    # color08="3B/75/8C" # Bright Black
